...
import { cancelProcessIngestionJob } from "@/lib/server/jobs/process-ingestion-jobs"
...
export async function POST(
  ...
  try {
    ...
    const job = await cancelProcessIngestionJob({
    ...
    return NextResponse.json(
      {
        error: "Error cancelando job de ingestion",
