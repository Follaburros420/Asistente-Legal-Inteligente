...
AS $$
DECLARE
  project_url TEXT := 'https://givjfonqaiqhsjjjzedc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdpdmpmb25xYWlxaHNqamp6ZWRjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MjE4NzU3MiwiZXhwIjoyMDY3NzYzNTcyfQ.41C4P-gF2LxdpR0qGuAu61WV0NO1fl3edztxq0DLmXg'; -- full access needed for http request to storage
