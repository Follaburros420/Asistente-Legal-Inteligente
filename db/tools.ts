...
export const createTools = async (
  ...
  if (error || !createdTools) {
    throw new Error(error?.message || "Failed to create tools")
  }
...
export const createToolWorkspaces = async (
  items: TablesInsert<"tool_workspaces">[]
) => {
...
export const updateTool = async (toolId: string, tool: TablesUpdate<"tools">) => {
